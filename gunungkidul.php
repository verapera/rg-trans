                ...
                <div class="col-lg-12">
                    ...
                    <div class="row g-1 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/drini.jpg" class="services_img" width="200px" 
                    ...
                    <div class="row g-4 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/parangtritis.jpg" class="services_img" width="200px" 
                            style="max-width:540px; 
                                        box-shadow: 5px 5px 5px rgba(0,0,0,0.5); 
                                        border-radius: 20px;  
                                        ">
                    ...
                    <div class="row g-4 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/indri.jpg" class="services_img" width="200px" 
                            style="max-width:540px; 
                                        box-shadow: 5px 5px 5px rgba(0,0,0,0.5); 
                                        border-radius: 20px;  
                                        ">
