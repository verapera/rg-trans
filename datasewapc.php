<?php
 ...
 if(!isset($_SESSION['id_admin'])){
  ...
  $query = "SELECT * FROM ds_privatecharter ORDER BY id DESC";
...
>
  <head>
    ...
    />
    <title>Data sewa Private charter</title>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php $no =1; foreach($hasil as $data){ ?>
                            <tr class="text-center">
                              ...
                              <td><?= $data['rute'];?></td>
                              <td><a class="btn btn-outline-danger" onclick="return confirm('Yakin menghapus data <?= $data['nama'];?> dari data private charter ?')"href="proses.php?hapus_bookingpc=<?= $data['id'] ?>">Hapus</a></td>
