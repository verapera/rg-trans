    ...
    <div class="container-xxl service py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h2 class="mb-5">Daftar layanan sewa mobil</h2>
            </div>
            <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
                <?php foreach($hasil as $data){?>
                <div class="col-lg-3 col-md-4 wow fadeInUp text-center">
                <a href="data_motor.php" > <img src="foto_mobil/<?=$data['foto']?>" class="services_img" width="255px"
                ...
                ></a>
                <h5 class="text-center font-weight-bold mt-3 mb-0">Mobil Self Drive & Plus Driver</h5>
