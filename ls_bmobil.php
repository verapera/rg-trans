...
require_once('koneksi.php');
    ...
    $query = "INSERT INTO `ds_mobil` 
            (`id`, `nama`, `alamat`, `telp`, `tglwkt_sewa`, `alamat_jemput`, `paket`, `jmobil`)
            VALUES 
            (NULL, '$nama', '$alamat', '$telp', current_timestamp(), '$alamat_jemput', '$paket', '$jmobil');";
...
$pdf->Ln(10);
$pdf->Cell(200,10,'LAPORAN SEWA MOBIL',0,0,'C');
$pdf->Ln(10);
...
$pdf->SetX(30);
$pdf->Cell(100,12,'Jenis Mobil                           :  ' . $jmobil,0,1,'');
$pdf->SetX(30);
...
header("Content-Disposition: attachment; filename=\"Laporan sewa mobil $nama .pdf\"");
