            ...
            <div class="container text-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Wonosobo/Dieng</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row g-4 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-lg-12">
                    <div class="ms-4">
                        ...
                        <h4>Tempat Wisata yang akan menjadi kunjungan di Wonosobo/Dieng Tour :</h4>

                    </div>
                    <!-- sikidang -->
                    <div class="row g-1 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/sikidang.jpg" class="services_img" width="200px" style="max-width:540px; 
                        ...
                        <div class="mt-4 col-lg-9">
                            <div>
                                <h4>1. Kawah Sikidang</h4>
                                <p align="justify">Kunjungi Keajaiban Alam Kawah Sikidang di Wonosobo! Nikmati pengalaman mendekati keajaiban alam ini yang menampilkan lanskap vulkanik yang eksotis dan berawa belerang yang unik.</p>
                            </div>
                        </div>
                    </div>
                    <!-- arjuna -->
                    <div class="row g-4 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/arjuna.jpg" class="services_img" width="200px" style="max-width:540px; 
                                        box-shadow: 5px 5px 5px rgba(0,0,0,0.5); 
                                        border-radius: 20px;  
                                        ">
                        </div>
                        <div class="mt-4 col-lg-9">
                            <div>
                                <h4>2. Candi Arjuna</h4>
                                <p align="justify">Selamat datang di Candi Arjuna, salah satu permata bersejarah Dieng! Jelajahi warisan budaya kuno kami di antara perbukitan hijau, di mana candi ini menjadi saksi bisu perjalanan waktu. </p>
                            </div>
                        </div>
                    </div>
                    <!-- tambi -->
                    <div class="row g-4 mt-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="mt-4 col-lg-3 col-md-3  wow fadeInUp text-center">
                            <img src="carserv/img/tambi.jpg" class="services_img" width="200px" style="max-width:540px; 
                                        box-shadow: 5px 5px 5px rgba(0,0,0,0.5); 
                                        border-radius: 20px;  
                                        ">
                        </div>
                        <div class="mt-4 col-lg-9">
                            <div>
                                <h4>3. Kebun Teh Tambi</h4>
                                <p align="justify">Rasakan pesona tenang dan segar di Kebun Teh Tambi Wonosobo! Di tengah perbukitan hijau, nikmati pemandangan indah kebun teh yang luas dan hijaunya tanaman teh yang subur.
                                </p>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div>
                        <h4>Keterangan paket Wonosobo/Dieng Tour :</h4>
