...
>
  <head>
    ...
    />
    <title>Laporan Private Charter</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
              <h5 class="card-header">Laporan Private Charter</h5>
              <div class="card-body">
                <div> 
                      ...
                      <table class="table table-bordered">
                        ...
                        $no=1;
                          if(isset($_POST['tampil'])){
                              ...
                              $data = mysqli_query($conn,"SELECT * FROM ds_privatecharter ORDER BY id DESC");
                          }
              ...
              <form action="excel_pc.php" method="post">
