<?php
 ...
 if(!isset($_SESSION['id_admin'])){
  ...
  $query = "SELECT * FROM ds_motor ORDER BY id DESC";
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php $no =1; foreach($hasil as $data){ ?>
                            <tr class="text-center">
                              ...
                              <td><?= $data['jmotor'];?></td>
                              <td><a class="btn btn-outline-danger" onclick="return confirm('Yakin menghapus data <?= $data['nama'];?> dari data motor ?')"href="proses.php?hapus_bookingmtr=<?= $data['id'] ?>">Hapus</a></td>
