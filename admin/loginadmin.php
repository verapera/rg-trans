            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">RG-Trans</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to RG-Trans! 👋</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="auth.php" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" name="loginadmin">Log in</button>
                </div>
              </form>
            </div>
          </div>
